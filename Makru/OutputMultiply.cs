...
namespace Makru
{
    class OutputMultiply : Output
    {
        ...
        public OutputMultiply(Output output1, Output output2, Macro macro)
        {
            m_output1 = output1;
            m_output2 = output2;
            m_macro = macro;
        ...
        {
            Variable v = Variable.Multiply(m_output1.GetOutput(), m_output2.GetOutput());
            Macros.AddLog("Play: OutputMultiply: " + (v != null ? v.Value : "Multiplikation nicht möglich!"));
            return v;
        }

        public override string GetText()
        {
            return m_output1.GetText() + " x " + m_output2.GetText();
        }
