...
namespace Makru
{
    class OutputDivide : Output
    {
        ...
        public OutputDivide(Output output1, Output output2, Macro macro)
        {
            m_output1 = output1;
            m_output2 = output2;
            m_macro = macro;
        ...
        {
            Variable v = Variable.Divide(m_output1.GetOutput(), m_output2.GetOutput());
            Macros.AddLog("Play: OutputDivide: " + (v != null ? v.Value : "Division nicht möglich!"));
            return v;
        }
