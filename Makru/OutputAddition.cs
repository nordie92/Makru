...
namespace Makru
{
    class OutputAddition : Output
    {
        ...
        public OutputAddition(Output output1, Output output2, Macro macro)
        {
            m_output1 = output1;
            m_output2 = output2;
            m_macro = macro;
        ...
        {
            Variable v = Variable.Addition(m_output1.GetOutput(), m_output2.GetOutput());
            Macros.AddLog("Play: OutputAddition: " + v.Value);
            return v;
        }
